namespace Portfolio.API.Services.Models
{
    ...
    public class ApplicationUserRegisterDto
    {
        ...
        [RegularExpression(@"[A-Z]{1}[\w]+", ErrorMessage = "The first name should start with capital letter.")]
        public string FirstName { get; set; }

        [Required]
        [MinLength(3, ErrorMessage = "The last name length shouldn't be less than 3 symbols.")]
        [RegularExpression(@"[A-Z]{1}[\w]+", ErrorMessage = "The last name should start with capital letter.")]
